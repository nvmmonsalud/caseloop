...
export const attemptSchema=z.object({recommendation:z.string(),evidence:z.string(),uncertainty:z.string(),position:z.enum(POSITION_OPTIONS),rationale:z.string(),risk:z.string(),mitigation:z.string(),confidence:z.number().min(20).max(100),coachResponse:z.string()});
